CREATE PROCEDURE rdp.create_user_specified_procedure
...
BEGIN
  ...
  IF (1=1 /* Extract Column infromation */) BEGIN
  ...
  IF (1=1 /* Build SQL Statemen for creation of "Stored Procedure" */) BEGIN
    ...
    SET @tx_sql  = @emp + 'CREATE PROCEDURE ' + @ip_nm_target_schema +'.usp_' + @ip_nm_target_table + ' AS'
    SET @tx_sql += @nwl + ''
    SET @tx_sql += @nwl + '/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */'
    SET @tx_sql += @nwl + '/* !!!                                                                            !!! */'
    SET @tx_sql += @nwl + '/* !!! This Stored Procdures has been generated by excuting the procedure of      !!! */'
    SET @tx_sql += @nwl + '/* !!! rdp.create_user_specified_procedure, see example here below.                                    !!! */'
    SET @tx_sql += @nwl + '/* !!!                                                                            !!! */'
    SET @tx_sql += @nwl + '/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */'
    SET @tx_sql += @nwl + '/* ' 
    SET @tx_sql += @nwl + '-- Example for `Generation of Ingestion Procedure`:'
    SET @tx_sql += @nwl + 'EXEC rdp.create_user_specified_procedure'
    ...
    SET @tx_sql += @nwl + 'GO'
    SET @tx_sql += @nwl + ''
    SET @tx_sql += @nwl + '-- Example for `Executing the Ingestion Procedure`:'
