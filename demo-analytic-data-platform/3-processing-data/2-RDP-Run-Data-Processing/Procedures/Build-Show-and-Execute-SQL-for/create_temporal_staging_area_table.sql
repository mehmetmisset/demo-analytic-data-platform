CREATE PROCEDURE rdp.create_temporal_staging_area_table
...
BEGIN
  ...
  IF (@is_dataset_found = 0 /* Extract "temp"-table with Columns of "Target"-table, exclude the "meta-attributes. */) BEGIN
    ...
    EXEC rdp.create_column_store_index @ip_nm_target_schema, @ip_nm_target_table, @ip_is_debugging, @ip_is_testing;
