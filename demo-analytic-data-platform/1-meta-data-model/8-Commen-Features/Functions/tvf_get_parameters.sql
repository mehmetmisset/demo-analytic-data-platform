CREATE FUNCTION rdp.tvf_get_parameters (
  ...
  SELECT pg.cd_parameter_group AS cd_parameter_group,
         ...
         REPLACE(REPLACE(REPLACE(REPLACE(pv.tx_parameter_value, 
           ...
           '<@ni_current_epoch>', CONVERT(NVARCHAR(10), rn.ni_current_epoch)
  ...
  JOIN srd.parameter_group AS pg ON pg.meta_is_active = 1 AND pg.id_parameter_group = pm.id_parameter_group
